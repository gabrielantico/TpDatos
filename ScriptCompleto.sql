...
-- Tabla de Provincias (modificada para incluir el país)
CREATE TABLE PROVINCIAS (
    id_provincia INT PRIMARY KEY,
    nom_provincia VARCHAR(100) NOT NULL,
    id_pais INT NOT NULL DEFAULT 1, -- Suponiendo que 1 es el ID para Argentina
...
-- Tabla de Tipos de Residencias
CREATE TABLE TIPOS_RESIDENCIAS (
    id_tipo_residencia INT PRIMARY KEY,
    descripcion VARCHAR(100) NOT NULL
);

-- Tabla de Tipos de Carreras
CREATE TABLE TIPOS_CARRERAS ( 
...
-- Tabla de Alumnos (Mejora: se agrega id_pais para permitir estudiantes internacionales)
CREATE TABLE ALUMNOS (
    ...
    id_pais INT, -- Nuevo campo para permitir el registro de estudiantes internacionales
    FOREIGN KEY (id_barrio) REFERENCES BARRIOS(id_barrio),
    FOREIGN KEY (id_estado_civil) REFERENCES ESTADOS_CIVIL(id_estado_civil),
    FOREIGN KEY (id_tipo_residencia) REFERENCES TIPOS_RESIDENCIAS(id_tipo_residencia),
    FOREIGN KEY (id_pais) REFERENCES PAISES(id_pais) -- Nueva clave foránea relacionada con la tabla de PAISES
);
...
CREATE TABLE CARRERAS ( 
    ...
    FOREIGN KEY (id_tipo_carrera) REFERENCES TIPOS_CARRERAS(id_tipo_carrera)
);

-- Relación entre Materias y Carreras (MATERIAS_CARRERAS)
CREATE TABLE MATERIAS_CARRERAS (
    id_materia_carrera INT PRIMARY KEY IDENTITY(1,1),
...
-- Inscripciones de Alumnos en Comisiones (referencia a MATERIAS_CARRERAS)
CREATE TABLE INSCRIPCIONES (
    id_inscripcion INT PRIMARY KEY,
    id_comision INT NOT NULL,
    id_materia_carrera INT NOT NULL, -- Referencia a MATERIAS_CARRERAS
    ...
    FOREIGN KEY (id_materia_carrera) REFERENCES MATERIAS_CARRERAS(id_materia_carrera), -- Relación con MATERIAS_CARRERAS
    FOREIGN KEY (id_alumno) REFERENCES ALUMNOS(id_alumno),
    FOREIGN KEY (id_estado) REFERENCES ESTADO_ACADEMICO(id_estado)
);

-- Relación entre Profesores y Comisiones
CREATE TABLE PROFESORES_COMISIONES (
    id_profesor_comision INT PRIMARY KEY,
...
-- Tabla de Asistencias (referencia a MATERIAS_CARRERAS)
...
-- Tabla de Exámenes (referencia a MATERIAS_CARRERAS)
CREATE TABLE EXAMENES (
    ...
    id_comision INT, -- Relaciona el examen con una comisión
    nota INT,
    fecha DATE NOT NULL,
    FOREIGN KEY (id_materia_carrera) REFERENCES MATERIAS_CARRERAS(id_materia_carrera), -- Relación con MATERIAS_CARRERAS
    FOREIGN KEY (id_profesor) REFERENCES PROFESORES(id_profesor),
    ...
    FOREIGN KEY (id_comision) REFERENCES COMISIONES(id_comision) -- Relación con COMISIONES
);
...
insert into EXAMENES (id_examen, id_materia_carrera, id_profesor, id_alumno, id_tipo_examen, nota, fecha) VALUES
(1, 1, 1, 1, 1, 6, '2024/08/10'),
(2, 1, 1, 2, 1, 5, '2024/08/10'),
(3, 1, 1, 3, 1, 8, '2024/08/10'),
(4, 1, 1, 4, 1, 8, '2024/08/10'),
(5, 1, 1, 5, 1, 10, '2024/08/10'),
(6, 1, 1, 6, 1, 2, '2024/08/10'),
(7, 1, 1, 7, 1, 4, '2024/08/10'),
(8, 1, 1, 8, 1, 10, '2024/08/10'),
(9, 1, 1, 9, 1, 7, '2024/08/10')
...
(33, 5, 3, 1, '09:45:00', '12:45:00', '2024-03-17', 3),
(34, 4, 4, 2, '08:50:00', '11:50:00', '2024-03-18', 1),
(35, 4, 5, 3, '09:00:00', '12:00:00', '2024-03-19', 2),
(36, 3, 6, 4, '11:00:00', '14:00:00', '2024-03-20', 3),
(37, 3, 7, 5, '10:15:00', '13:15:00', '2024-03-21', 2),
(38, 2, 8, 6, '09:30:00', '12:30:00', '2024-03-22', 1),
(39, 2, 9, 7, '10:45:00', '13:45:00', '2024-03-23', 3),
(40, 1, 10, 8, '08:15:00', '11:15:00', '2024-03-24', 2),
(41, 1, 1, 9, '08:00:00', '12:00:00', '2024-03-25', 1),
(42, 2, 2, 10, '09:30:00', '13:30:00', '2024-03-26', 2),
(43, 3, 3, 11, '10:00:00', '14:00:00', '2024-03-27', 3),
(44, 4, 4, 12, '11:30:00', '15:30:00', '2024-03-28', 1),
(45, 5, 5, 13, '08:45:00', '12:45:00', '2024-03-29', 2),
(46, 1, 6, 14, '09:15:00', '13:15:00', '2024-03-30', 3),
(47, 1, 7, 15, '08:00:00', '11:00:00', '2024-04-01', 1),
(48, 2, 8, 16, '10:30:00', '13:30:00', '2024-04-02', 2),
(49, 3, 9, 17, '11:00:00', '14:00:00', '2024-04-03', 3),
(50, 4, 10, 18, '09:30:00', '12:30:00', '2024-04-04', 1),
(51, 5, 1, 19, '10:00:00', '13:00:00', '2024-04-05', 2),
(52, 5, 2, 20, '11:15:00', '14:15:00', '2024-04-06', 3),
(53, 4, 3, 21, '09:45:00', '12:45:00', '2024-04-07', 1),
(54, 3, 4, 22, '08:50:00', '11:50:00', '2024-04-08', 2),
(55, 2, 5, 23, '10:00:00', '13:00:00', '2024-04-09', 3),
(56, 1, 6, 24, '11:30:00', '14:30:00', '2024-04-10', 1),
(57, 1, 7, 25, '08:15:00', '11:15:00', '2024-04-11', 2),
(58, 2, 8, 26, '09:30:00', '12:30:00', '2024-04-12', 3),
(59, 3, 9, 27, '10:45:00', '13:45:00', '2024-04-13', 1),
(60, 4, 10, 28, '08:00:00', '11:00:00', '2024-04-14', 2);
...
(60, 1, 1, 1, 1, 1, 8.50, '2021-03-10'),
(61, 2, 2, 2, 2, 2, 7.25, '2022-05-20'),
(62, 3, 3, 3, 1, 3, 9.00, '2023-06-15'),
(63, 4, 4, 4, 2, 4, 6.75, '2023-07-10'),
(64, 5, 5, 5, 1, 5, 8.00, '2024-01-05'),
(65, 6, 6, 6, 2, 1, 5.50, '2024-02-28'),
(66, 7, 7, 7, 1, 2, 7.90, '2022-08-15'),
(67, 8, 8, 8, 2, 3, 6.50, '2023-09-18'),
(68, 9, 9, 9, 1, 4, 9.50, '2021-12-25'),
